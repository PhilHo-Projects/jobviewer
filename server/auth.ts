...
// Legacy identity shape, used only by the hand-rolled auth that Task 7 deletes.
import type { SessionUser as LegacySessionUser } from '../shared/types.js';
...
export function attachUser(db: Db, secret: string) {
    return (req: AuthedRequest, _res: Response, next: NextFunction): void => {
        let user: LegacySessionUser | null = null;
